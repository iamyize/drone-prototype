...
class Tello:
    ...
    def __init__(self,
        ...
        # Added response_timeout as instance attribute
    ...
    def send_command_with_return(self, command: str, timeout: int = None) -> str:
    ...
    def send_control_command(self, command: str, timeout: int = None) -> bool:
